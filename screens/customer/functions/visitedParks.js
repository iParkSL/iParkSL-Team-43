            ...
            <View style={{width }}>
                <ScrollView>
                    {/* <View style={styles.title}>
                        <Text style={{fontSize:30,textAlign:'center',fontWeight:'bold'}}>Recently use Parks</Text>
                    </View> */}
                    <View style={{flexDirection:'row',padding:10,backgroundColor:'#ffd700'}}>
                        ...
                        <View style={{width:"90%"}}>
                            <Text style={{fontSize:30,textAlign:'center',fontWeight:'bold'}}>Visited Parks</Text>
                        </View>
                    </View>
