            ...
            <View style={{width }}>
                ...
                <SafeAreaView>
                    ...
                    <View style={{flexDirection:'row',padding:10,backgroundColor:'#ffd700'}}>
                        ...
                        <View style={{width:"90%"}}>
                            <Text style={{fontSize:30,textAlign:'center',fontWeight:'bold'}}>Recent Bookings</Text>
                        </View>
                    </View>
                    <View>
                        <FlatList
                            ...
                            renderItem={({item})=>  <View style={{flex:1,padding:10,borderRadius:10,width:"90%",height:120,margin:"5%",marginBottom:10,flexDirection:'row',shadowColor:"#000",shadowOffset:{width:0,height:1,},shadowOpacity:0.8,shadowRadius:2.22,elevation:3}} >
